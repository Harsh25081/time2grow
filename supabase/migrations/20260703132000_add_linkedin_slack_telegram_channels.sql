...
alter table public.integration_accounts
  ...
  check (provider in ('facebook', 'instagram', 'linkedin', 'youtube', 'google_ads', 'whatsapp', 'slack', 'telegram'));
...
alter table public.distribution_handles
  ...
  check (handle_type in ('facebook_page', 'instagram_business', 'linkedin_page', 'youtube_channel', 'google_ads_customer', 'whatsapp_phone_number', 'slack_channel', 'telegram_channel'));
